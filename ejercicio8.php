...
if ($num1 < $num2) {
    $resultado = "El primer numero (" . $num1 . ") es menor que el segundo numero (" . $num2 . ").";
} elseif ($num2 < $num1) {
    $resultado = "El segundo numero (" . $num2 . ") es menor que el primer numero (" . $num1 . ").";
} else {
...
echo "<a href='ejercicio8.html'>Regresar al formulario</a>";
echo "<br><br>";
